...
exports.getConsultations = async (req, res) => {
    try {
        ...
        // Also exclude expired consultations that have been re-requested
        // (they're replaced by new consultations, no need to show old ones)
        query.hasBeenReRequested = { $ne: true };
